                ...
                <div class="col-md-8">
                    <div id="watch">
                        ...
                        <div class="video-share">
                            <ul class="like">
                                <li><a class="deslike" href="{{route('videos.dislike' , $video)}}">{{$video->Dislikes_count}}<i class="fa fa-thumbs-down"></i></a></li>
                                <li><a class="like" href="{{route('videos.like' , $video)}}">{{$video->likes_count}}<i class="fa fa-thumbs-up"></i></a></li>
                            </ul>
