        ...
        <div class="form-output">
        	...
        	<form action="{{route('login.store')}}" method="post">
				...
				<div class="form-group label-floating">
					...
					<input class="form-control" name="email" placeholder="Example : MansourLiaghat@yahoo.com" type="email">
				</div>
				<div class="form-group label-floating">
					<label class="control-label">رمز عبور</label>
					<input class="form-control" name="password" placeholder="*Example : Aa123456789" type="password">
				</div>
